...
b = -bL-sqrt(gL*(1-gL)) % segno - -> suscettanza positiva
CB = b/(2*pi*f*Z0) % elemento jB -> capacità 1.1658 pF
...
PLa = 1-(abs(Gamma1))^2 % potenza attiva al carico 93.02%

x = -sqrt(gL*(1-gL))/gL % segno - -> reattanza negativa
CX = -1/(2*pi*f*(x*Z0)) % elemento jX -> capacità 2.9058 pF
